...
import { ArrowLeft, Monitor, Link2, Unlink, Loader2, AlertTriangle, RefreshCw, CheckCircle2, Shield, ExternalLink, Info } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Badge } from "@/components/ui/badge";
import { Separator } from "@/components/ui/separator";
import { useToast } from "@/hooks/use-toast";
import { useDigitalImport } from "@/hooks/useDigitalImport";
import type { ImportLastError } from "@/hooks/useDigitalImport";
      ...
      <div className="w-full max-w-3xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">Hantera dina kopplingar till externa tjänster</p>
          </div>
        </div>
              ...
              <div className="p-5 sm:p-6 flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                    Importera transkript från dina Teams-möten direkt till Tivly via Microsoft 365. 
                    Kräver att Teams-transkribering är aktiverat för mötet.
                  </p>
                </div>
              </div>
