...
/**
 * Upload audio file to ASR backend using a single minimal fetch call.
 */
export async function uploadToAsr(options: AsrUploadOptions): Promise<AsrUploadResult> {
  ...
  // Build fresh FormData - append file directly, no preprocessing
  ...
  // Do NOT log, iterate, or inspect formData after appending
